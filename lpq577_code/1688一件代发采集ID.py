...
def get_sign(p):
    with open(
        r"C:\Users\Administrator\PycharmProjects\pythonProject\huangjinlang\lpq577_code\配置文件\1688js算法.js",
        "r",
        encoding="utf-8",
    ) as f:
...
if __name__ == "__main__":
    ...
    data = {
        "sceneSearchParamStr": '{"keyword":"手机壳","pageSize":50,"pageIndex":1,"filter":[],"sortModel":"","sceneCode":"","searchMode":"KEYWORD_SEARCH"}'
    }

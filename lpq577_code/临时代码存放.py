tetx = {
    ...
    "data": {
        ...
        "skumodel": {
            "sku_data": {
                "sku_property_name": {"sku1_property_name": "颜色"},
                "sku_parameter": [
                    {
...
text = []
for value in tetx["data"]["skumodel"]["sku_data"]["sku_property_name"].values():
    text.append(value)
for i in tetx["data"]["skumodel"]["sku_data"]["sku_parameter"]:
    text.append(i["name"])
new_list = text

keys = list(tetx["data"]["skumodel"]["sku_data"]["sku_property_name"].keys())
for i, key in enumerate(keys):
    tetx["data"]["skumodel"]["sku_data"]["sku_property_name"][key] = new_list[i]

for i in range(len(tetx["data"]["skumodel"]["sku_data"]["sku_parameter"])):
    tetx["data"]["skumodel"]["sku_data"]["sku_parameter"][i]["name"] = new_list[
        i + len(keys)
    ]
